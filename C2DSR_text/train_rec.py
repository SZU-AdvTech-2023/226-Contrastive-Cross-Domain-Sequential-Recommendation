...
parser.add_argument('--source_text', type=str, default='/home/temp_user/yanjie/C2DSR_src_new/dataset/Book-Movie/source_item_text.CLS')
parser.add_argument('--target_text', type=str, default='/home/temp_user/yanjie/C2DSR_src_new/dataset/Book-Movie/target_item_text.CLS')
...
parser.add_argument('--test_sort', action='store_false', default=True)
parser.add_argument('--neg_type',choices=['popular', 'random',], default='popular',
                    help='the negative item type for evaluate and test.')
...
for epoch in range(1, opt['num_epoch'] + 1):
    ...
    def cal_test_score(predictions):
        ...
        for pred in predictions:
            ...
            MRR += 1 / pred
            # 解释：如果预测的位置在前10，那么HR_10就加1
            if pred <= 1:
                HR_1 += 1
            #  解释：如果预测的位置在前5，那么HR_5就加1
            if pred <= 5:
    ...
    # 如果验证集中的结果大于历史最大的测试结果，那么进行测试集的测试。
